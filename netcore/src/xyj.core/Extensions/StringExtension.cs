...
namespace xyj.core.Extensions
{
    public static class StringExtension
    {
        ...
        public static int DoQuery(this string sql, string connStr, ClientType type )
        {
            var result = -1;
            switch (type)
            {
        ...
        public static List<List<string>> DoReader(this string sql, string connStr, ClientType type )
        {
        ...
        {
            return sql.DoQuery(connStr,Setting.DbClientType);
        }
        public static List<List<string>> ExecuteReader(this string sql, string connStr)
        {
            return sql.DoReader(connStr, Setting.DbClientType);
