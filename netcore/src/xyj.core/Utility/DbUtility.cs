...
namespace xyj.core.Utility
{
    ...
    public static class DbUtility
    {
        ...
        public static string ConnString(string database)
        {
            switch (Setting.DbClientType)
            {
                case ClientType.MySql:
                    return MySqlConnString(Setting.DbHost,database.CheckDb(),  Setting.DbUser, Setting.DbPassword);
                case ClientType.SqlSever:
                    return SqlSeverConnString(database.CheckDb(), Setting.DbHost, Setting.DbUser,Setting.DbPassword);
                case ClientType.Oracle:
                    return OracleConnString( Setting.DbHost, Setting.ServiceName, Setting.DbUser, Setting.DbPassword);
