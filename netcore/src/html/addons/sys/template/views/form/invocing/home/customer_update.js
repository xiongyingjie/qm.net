...
cfg.push(
    group([
        ...
        hide('customer-pinyin', ''),
        input('结帐方式', 'customer-checkout_method', '', '4'),
        input('结帐周期', 'customer-checkout_period', '', '4'),
        input('价格级别', 'customer-price_level', '', '4'),
...
return cfg;
}, 'erp.invoicing.customer@update&id=' + q.id, 'erp.invoicing.customer@find&id=' + q.id,'编辑客户信息');