...
render([
    ...
    ], '销售单信息')], 'erp.invoicing.invoicing_order@add|sell_order@add', '', '新增销售单', '', '', function (data, code, msg) {
         $.msg("请继续为销售单添加商品");
        _c.go("*r/invocing/home/invoicing_order_item_list?id=" + id,1);
});